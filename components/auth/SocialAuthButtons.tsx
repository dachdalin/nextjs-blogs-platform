...
export default function SocialAuthButtons({ mode }: SocialAuthButtonsProps) {
  ...
  const socialProviders = [
    ...
    },
    {
      ...
      bgColor:
        "bg-black hover:bg-gray-900 dark:bg-gray-900 dark:hover:bg-gray-800",
      textColor: "text-white",
      ...
      <div className="grid grid-cols-3 gap-3">
        {socialProviders.map((provider) => (
          <button
            ...
            className={`flex items-center justify-center rounded-lg border px-4 py-2.5 font-medium transition focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:opacity-50 ${provider.bgColor} ${provider.textColor} ${provider.borderColor}`}
